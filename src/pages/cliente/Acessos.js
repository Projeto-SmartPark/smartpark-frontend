          ...
          <TableContainer component={Paper}>
            <Table>
              <TableHead sx={{ backgroundColor: '#223843' }}>
                <TableRow>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Estacionamento</TableCell>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Identificação da Vaga</TableCell>
                  <TableCell sx={{ color: 'white', fontWeight: 600 }}>Veículo</TableCell>
                ...
                {acessos.length === 0 ? (
                  ...
                  acessos.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((acesso) => (
                    <TableRow key={acesso.id_acesso} hover>
                      <TableCell>{acesso.vaga?.estacionamento?.nome || '-'}</TableCell>
                      <TableCell sx={{ fontWeight: 600 }}>{acesso.vaga?.identificacao || '-'}</TableCell>
                      <TableCell sx={{ fontWeight: 600 }}>{acesso.veiculo?.placa || '-'}</TableCell>
                      <TableCell>{formatarData(acesso.data)}</TableCell>
                      <TableCell>{formatarHora(acesso.hora_inicio)}</TableCell>
                      <TableCell>{formatarHora(acesso.hora_fim)}</TableCell>
                      <TableCell sx={{ color: '#2A9D8F', fontWeight: 600 }}>
